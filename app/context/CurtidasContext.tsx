...
import { CurtidasContextType } from "@/app/types/types";

const CurtidasContext = createContext<CurtidasContextType | undefined>(undefined);

export const CurtidasProvider = ({ children }: { children: React.ReactNode }) => {
...
export const useCurtidasContext = () => {
  ...
  if (!context) {
    throw new Error("useCurtidasContext deve ser usado dentro do CurtidasProvider");
  }
  return context;
};