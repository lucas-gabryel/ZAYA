...
describe("CardProduto", () => {
  ...
  it("TU01 - Deve renderizar imagem, título e preço corretamente", () => {
    render(
      <CardProduto id="1" image="/camisaMinimal.png" title="Tênis ZAYA" price="199.99" />,
  ...
  it("TU02 - Deve chamar toggleCurtida ao clicar no botão de curtir", () => {
    render(
      <CardProduto id="1" image="/camisaMinimal.png" title="Produto" price="100.00" />,
      { wrapper: AllProviders }
    );
  ...
  it("TU03 - Deve aplicar classe de curtido quando o item estiver curtido", () => {
    render(
      <CardProduto id="curtido" image="/camisaMinimal.png" title="Produto" price="100.00" />,
      { wrapper: AllProviders }
    );
  ...
  it("TU04 - Deve chamar compartilhar com URL, título e mensagem ao clicar", () => {
    render(
      <CardProduto id="5" image="/camisaMinimal.png" title="Produto" price="100.00" />,
      { wrapper: AllProviders }
    );
  ...
  it("TU05 - Deve conter dois botões com ícones de curtir e compartilhar", () => {
    render(
      <CardProduto id="3" image="/camisaMinimal.png" title="Produto" price="99.00" />,
      { wrapper: AllProviders }
    );
  ...
  it("TU06 - Deve renderizar a imagem com src e alt corretos", () => {
    render(
      <CardProduto id="10" image="/camisaMinimal.png" title="Tênis ZAYA" price="150.00" />,
      { wrapper: AllProviders }
    );
